...
const FAQ_DATA = [
  ...
  // SARATHI AI
  {
    ...
    answer: "No. Sarathi is an AI spiritual guide powered by Llama 3 models through a RAG system that searches our scripture database. It does not have real-time internet access, cannot predict the future, and should not replace professional advice for medical, legal, or financial matters."
  },
  {
    id: "ai-2",
    category: "Sarathi AI",
